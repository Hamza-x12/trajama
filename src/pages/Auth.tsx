  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-primary/5 to-accent/5 p-4">
        <Card className="w-full max-w-md p-8 bg-card/80 backdrop-blur-sm border-border/50 shadow-elegant">
          <div className="flex flex-col items-center space-y-6">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-muted-foreground">
                Sign in to save your progress and continue learning Darija
              </p>
            </div>
            ...
            <div className="text-center text-sm text-muted-foreground">
              By signing in, you agree to save your learning progress and translation history
            </div>
